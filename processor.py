...
flag_preprocessor_resolution = "רזולוציית טרום-מעבד"
preprocessor_sliders_config = {
    ...
    "canny": [
        ...
        {
            "name": "Canny סף נמוך של",
            "value": 100,
            "min": 1,
            "max": 255
        },
        {
            "name": "Canny סף גבוה של",
            "value": 200,
            "min": 1,
            "max": 255
        },
    ...
    "reference_only": [
        None,
        {
            "name": r'("נאמנות לסגנון (רק עבור מצב "מאוזן',
            "value": 0.5,
            "min": 0.0,
            "max": 1.0,
            "step": 0.01
